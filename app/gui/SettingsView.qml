...
Flickable {
    ...
    Column {
        ...
        GroupBox {
            ...
            padding: 12
            title: "<font color=\"#6366F1\">" + qsTr("Basic Settings") + "</font>"
            font.pointSize: 12
        ...
        GroupBox {
            ...
            width: (parent.width - (parent.leftPadding + parent.rightPadding))
            padding: 12
            title: "<font color=\"#6366F1\">" + qsTr("Audio Settings") + "</font>"
            font.pointSize: 12
            ...
            Column {
                ...
                CheckBox {
                    ...
                    width: parent.width
                    text: qsTr("Mute audio stream when Vibelight is not the active window")
                    font.pointSize: 12
                    visible: SystemProperties.hasDesktopEnvironment
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Mutes Vibelight's audio when you Alt+Tab out of the stream or click on a different window.")
                }

                CheckBox {
                    id: micCaptureCheck
                    width: parent.width
                    text: qsTr("Send microphone to host PC")
                    font.pointSize: 12
                    checked: StreamingPreferences.micCapture
                    onCheckedChanged: {
                        StreamingPreferences.micCapture = checked
                    }

                    ToolTip.delay: 1000
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Captures your microphone and streams it to the host PC. Requires Vibepollo on the host. Uses Steam Streaming Microphone (no third-party driver needed). Steam must be running on the PC.")
                }
        ...
        GroupBox {
            ...
            width: (parent.width - (parent.leftPadding + parent.rightPadding))
            padding: 12
            title: "<font color=\"#6366F1\">" + qsTr("Host Settings") + "</font>"
            font.pointSize: 12
        ...
        GroupBox {
            ...
            width: (parent.width - (parent.leftPadding + parent.rightPadding))
            padding: 12
            title: "<font color=\"#6366F1\">" + qsTr("UI Settings") + "</font>"
            font.pointSize: 12
                    ...
                    onActivated : {
                        ...
                        if (StreamingPreferences.language !== new_language) {
                            ...
                            if (!StreamingPreferences.retranslate()) {
                                ToolTip.show(qsTr("You must restart Vibelight for this change to take effect"), 5000)
                            }
                            else {
    ...
    Column {
        ...
        GroupBox {
            ...
            width: (parent.width - (parent.leftPadding + parent.rightPadding))
            padding: 12
            title: "<font color=\"#6366F1\">" + qsTr("Input Settings") + "</font>"
            font.pointSize: 12
                ...
                Row {
                    ...
                    CheckBox {
                        ...
                        ToolTip.text: qsTr("This enables the capture of system-wide keyboard shortcuts like Alt+Tab that would normally be handled by the client OS while streaming.") + "\n\n" +
                                      qsTr("NOTE: Certain keyboard shortcuts like Ctrl+Alt+Del on Windows cannot be intercepted by any application, including Vibelight.")
                    }
        ...
        GroupBox {
            ...
            width: (parent.width - (parent.leftPadding + parent.rightPadding))
            padding: 12
            title: "<font color=\"#6366F1\">" + qsTr("Gamepad Settings") + "</font>"
            font.pointSize: 12
            ...
            Column {
                ...
                CheckBox {
                    ...
                    width: parent.width
                    text: qsTr("Process gamepad input when Vibelight is in the background")
                    font.pointSize: 12
                    visible: SystemProperties.hasDesktopEnvironment
                    ...
                    ToolTip.timeout: 5000
                    ToolTip.visible: hovered
                    ToolTip.text: qsTr("Allows Vibelight to capture gamepad inputs even if it's not the current window in focus")
                }
            }
        }
        ...
        GroupBox {
            ...
            width: (parent.width - (parent.leftPadding + parent.rightPadding))
            padding: 12
            title: "<font color=\"#6366F1\">" + qsTr("Advanced Settings") + "</font>"
            font.pointSize: 12
