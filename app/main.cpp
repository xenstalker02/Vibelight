...
LONG WINAPI UnhandledExceptionHandler(struct _EXCEPTION_POINTERS *ExceptionInfo)
{
    ...
    swprintf_s(dmpFileName, L"%ls\\Vibelight-%I64u.dmp",
...
int main(int argc, char *argv[])
{
...
#endif
    {
        s_LoggerFile = new QFile(tempDir.filePath(QString("Vibelight-%1.log").arg(QDateTime::currentSecsSinceEpoch())));
    ...
    QStringList existingLogNames = tempDir.entryList(QStringList("Vibelight-*.log"), QDir::NoFilter, QDir::SortFlag::Time);
